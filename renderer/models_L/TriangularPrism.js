...
//   }
   ...
   <p>
      ...
      @param {number} [r=.5/Math.sqrt(3)]  radius of circle in xz-plane that the equilateral triangle is inscribed in
      @param {number} [h=.6]  the body of the prism runs from h to -h in the y-direction
      @param {number} [h2=r*Math.tan(Math.atan(Math.sqrt(2)))]  height of each tetrahedron at the ends of the prism
   ...
   */
   ...
   {
      super(undefined, undefined, undefined, undefined, format("Triangular Prism(%.2f,%.2f,%.2f,%d)", r, h, h2, n));
