...
int main(int argc, char** argv)
{
   ...
   window = glutCreateWindow("Nested Circles v2");
...
void display(void)
{
   ...
   glTranslatef(3.0*cos(sliderValue1*2.0*PI), 3.0*sin(sliderValue1*2.0*PI), 0.0);
   ...
   glPushMatrix();
     ...
     glTranslatef(1.5*cos(sliderValue3*2.0*PI), 1.5*sin(sliderValue3*2.0*PI), 0.0);
