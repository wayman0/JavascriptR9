...
import {Scene, Model, Position, Vertex, LineSegment} from "../renderer/scene/SceneImport.js";
import {FrameBuffer, Viewport} from "../renderer/framebuffer/FramebufferImport.js";
import Color from "../renderer/color/Color.js";
import {render, setClipDebug, setDoAntiAliasing, setDoGamma, setRastDebug} from "../renderer/pipeline/PipelineImport.js";
...
render(scene, vp1);
render(scene, vp2);
fb.dumpFB2File("LinesInTwoViewports_R9.ppm");